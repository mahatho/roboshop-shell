...
for name in ${instances[@]}; do
    ...
    instance_id=$(aws ec2 run-instances --image-id ami-041e2ea9402c46c32 --instance-type t3.micro --security-group-ids sg-0b7ae9cc652c13cff --subnet-id subnet-06f4a00901c35a94d --query 'Instances[0].InstanceId' --output text)
